                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <p class="text-muted mt-4">
                            Founded in 2020, SIMple SIM was founded by five jetsetting Wharton MBA students with a mission to
                    ...
                    <div class="col-md-3 text-center">
                        ...
                        <p class="text-muted mt-4">
                            Send us an email at <a href="#contact-support-footer">support@simple.sim</a> if you have any qustions. We'll help you out.
                        </p>
                    </div>
                </div>
                <hr class="my-5"/>
